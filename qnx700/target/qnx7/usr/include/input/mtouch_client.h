...
typedef struct mtouch_data {
	int touch_down;
	int negligeable_move;
	_Uint32t contact_id;
	...
	_Int32t x_raw;
	_Int32t y_raw;
	_Uint32t touch_width;
	_Uint32t touch_height;
	_Uint32t touch_orientation;
	_Uint32t touch_pressure;
	_Uint64t timestamp;
	int modified;
	int flags;
} mtouch_data_t;
...
void mtouch_set_external(struct input_descriptor* id, void *device, void *screen_evt, void (*inject)(int event_type, void *, void *, void *) );
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/inputevents/public/input/mtouch_client.h $ $Rev: 806494 $")
#endif
