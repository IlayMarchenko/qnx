...
/* x86_64 ABI says stacks must be 16 byte aligned */
#define NW_STK_ALIGN 16
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/io-pkt/sys/nw_defs.h $ $Rev: 780356 $")
#endif
