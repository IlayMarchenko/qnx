...
#elif defined(__LINUX__) || defined(__FreeBSD__) || defined(__DARWIN__)
#include <stddef.h>
#include <sys/types.h>
#include <stdint.h>
#include <sys/stat.h>
...
/* support for large file I/O is already 64 bit on Apple since OSX 10.5*/
/* types */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/compat/public/lib/compat.h $ $Rev: 811056 $")
#endif
