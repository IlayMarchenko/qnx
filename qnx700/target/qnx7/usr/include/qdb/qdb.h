...
extern int			qdb_collation_ext(qdb_hdl_t *db, void *data, int nbytes, int reindex);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/qdb/public/qdb/qdb.h $ $Rev: 779086 $")
#endif
