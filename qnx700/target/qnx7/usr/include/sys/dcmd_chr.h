...
#define DCMD_CHR_GETOBAND		__DIOF(_DCMD_CHR, 25, 0)
	...
	#define _OBAND_SER_EXTENDED		0x80	/* Use DCMD_CHR_GETOBAND_EXTENDED to read extended device specific data */
...
/*
 * Desc:   This call is made to read device specific 'out of band' data in response to the
 *         _OBAND_SER_EXTENDED bit being set in the value returned from the DCMD_CHR_GETOBAND command.
 * Notes:  Not all drivers make use of this devctl.
 * Args:   A pointer to an unsigned integer that is filled in by the terminal device
 */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/io-char/public/sys/dcmd_chr.h $ $Rev: 780860 $")
#endif
