...
#define PROCMGR_AID_MAX					PROCMGR_AID_ABLE_PRIV
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/services/system/public/sys/procmgr.h $ $Rev: 819620 $")
#endif
