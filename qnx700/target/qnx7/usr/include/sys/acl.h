...
int acl_get_perm_np(acl_permset_t __permset_d, acl_perm_t __perm);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/sys/acl.h $ $Rev: 780356 $")
#endif
