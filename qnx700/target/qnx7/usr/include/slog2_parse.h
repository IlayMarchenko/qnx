...
typedef struct {
    ...
    _Uint32t                    register_flags;         /*!< flags that were passed to slog2_register()*/
} slog2_packet_info_t;
...
#define SLOG2_PARSE_SETTINGS_VERBOSE (1<<0)
/**
 * applies global settings
 * @param flags     flags to set global settings
 * @return  0 on success, -1 on failure.
 */
int slog2_parse_settings( _Uint32t __flags );
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/slog2parse/public/slog2_parse.h $ $Rev: 816041 $")
#endif
