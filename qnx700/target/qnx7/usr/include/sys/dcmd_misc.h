...
#define DCMD_MISC_MQGETATTR		__DIOF(_DCMD_MISC, 1, struct __msg_mq_attr)
#define DCMD_MISC_MQSETATTR		__DIOT(_DCMD_MISC, 2, struct __msg_mq_attr)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/sys/dcmd_misc.h $ $Rev: 780356 $")
#endif
