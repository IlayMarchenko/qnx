...
enum opt_code
{
  ...
  OPT_stdlib_libc__ = 1378,                  /* -stdlib=libc++ */
  OPT_stdlib_libcpp = 1379,                  /* -stdlib=libcpp */
  OPT_stdlib_libcpp_ne = 1380,               /* -stdlib=libcpp-ne */
  OPT_stdlib_libstdc__ = 1381,               /* -stdlib=libstdc++ */
  OPT_symbolic = 1382,                       /* -symbolic */
  OPT_t = 1383,                              /* -t */
  OPT_time = 1384,                           /* -time */
  OPT_time_ = 1385,                          /* -time= */
  OPT_traditional = 1386,                    /* -traditional */
  OPT_traditional_cpp = 1387,                /* -traditional-cpp */
  OPT_trigraphs = 1388,                      /* -trigraphs */
  OPT_u = 1389,                              /* -u */
  OPT_undef = 1390,                          /* -undef */
  OPT_v = 1391,                              /* -v */
  OPT_version = 1392,                        /* -version */
  OPT_w = 1393,                              /* -w */
  OPT_wrapper = 1394,                        /* -wrapper */
  OPT_x = 1395,                              /* -x */
  OPT_z = 1396,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
