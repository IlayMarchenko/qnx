...
#define _CONNECT_CTRL_NON_CANCELLATION_POINT		0x0000
#define _CONNECT_CTRL_CANCELLATION_POINT			0x0001

#define _CONNECT_CTRL_COF_CLOEXEC					0x0002  /* to set _NTO_COF_CLOEXEC */
#define _CONNECT_CTRL_COF_INSECURE					0x0004  /* to set _NTO_COF_INSECURE */
#define _CONNECT_CTRL_COF_NOEVENT					0x0008  /* to set _NTO_COF_NOEVENT */
#define _CONNECT_CTRL_CALLER_FLAG_MASK				0xffff
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/fcntl.h $ $Rev: 818175 $")
#endif
