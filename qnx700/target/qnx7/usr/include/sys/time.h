...
struct __timeval32 {
	_Time32t		tv_sec;		/* seconds */
    suseconds_t		tv_usec;	/* microseconds */
};

struct __timeval64 {
	_Time64t		tv_sec;		/* seconds */
    suseconds_t		tv_usec;	/* microseconds */
};
...
extern int utimes (const char *__path, const struct timeval __times[2]);
__END_DECLS
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/sys/time.h $ $Rev: 806926 $")
#endif
