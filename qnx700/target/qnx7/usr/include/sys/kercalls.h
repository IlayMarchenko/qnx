...
enum {
	...
	__KER_SYS_SRANDOM,				/*  4		0x04 */
	__KER_SPARE3,					/*  5		0x05 */
	__KER_MSG_SEND_PULSEPTR,		/*  6		0x06 */
	...
	__KER_SIGNAL_KILL_SIGVAL,		/* 33		0x21 */
	...
	__KER_POWER_PARAMETER,			/* 100		0x64 */
	__KER_POWER_ACTIVE,				/* 101		0x65 */
	__KER_SCHED_WAYPOINT,			/* 102		0x66 */
	__KER_POWER_SPARE2,				/* 103		0x67 */
	__KER_POWER_SPARE3,				/* 104		0x68 */
	__KER_POWER_SPARE4,				/* 105		0x69 */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/services/system/public/sys/kercalls.h $ $Rev: 781829 $")
#endif
