...
CC_nto_arm_clang = $(CC_nto_arm_clang_v7)
AS_nto_arm_clang = $(AS_nto_arm_clang_v7)
AR_nto_arm_clang = $(AR_nto_arm_clang_v7)
LR_nto_arm_clang = $(LR_nto_arm_clang_v7)
LD_nto_arm_clang = $(LD_nto_arm_clang_v7)
OC_nto_arm_clang = $(OC_nto_arm_clang_v7)
...
CC_nto_arm_clang += -pipe $(OPTIMIZE_$(OPTIMIZE_TYPE)_gcc) -Wall
AS_nto_arm_clang += -pipe $(OPTIMIZE_$(OPTIMIZE_TYPE)_gcc) $(addprefix -I$, $(INCVPATH)) $(foreach var,$(VARIANT_NAMES), -Wa$(comma)--defsym$(comma)$(var)=1)
AR_nto_arm_clang += -r
LD_nto_arm_clang += -Wl,--no-keep-memory
LDBOOTSTRAP_nto_arm_clang  = $(LR_nto_arm_clang) -Wl,--no-keep-memory -nostartfiles -Wl,-u_start
LDBOOTSTRAPPOST_nto_arm_clang  = $(LRPOST_nto_arm_clang)
