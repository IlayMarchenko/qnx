...
typedef struct {
	...
	gesture_coords_t centroid;        /**< The coordinates of the midpoint between the two touches. */
 ...
 *
 * This function allocates a new two-finger pan gesture data structure, initializes it with the specified
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/gestures/public/gestures/two_finger_pan.h $ $Rev: 812267 $")
#endif
