...
enum opt_code
{
  ...
  OPT_Wignored_attributes = 255,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 256,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 257,                       /* -Wimplicit */
  OPT_Wimplicit_function_declaration = 258,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 259,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 260,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 261,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 262, */                   /* -Wimport */
  OPT_Wincompatible_pointer_types = 263,     /* -Wincompatible-pointer-types */
  OPT_Windirect_static = 264,                /* -Windirect-static */
  OPT_Winherited_variadic_ctor = 265,        /* -Winherited-variadic-ctor */
  OPT_Winit_self = 266,                      /* -Winit-self */
  OPT_Winline = 267,                         /* -Winline */
  OPT_Wint_conversion = 268,                 /* -Wint-conversion */
  OPT_Wint_to_pointer_cast = 269,            /* -Wint-to-pointer-cast */
  ...
  OPT_Xassembler = 442,                      /* -Xassembler */
  OPT_Xlinker = 443,                         /* -Xlinker */
  OPT_Xpreprocessor = 444,                   /* -Xpreprocessor */
  OPT_Z = 445,                               /* -Z */
  OPT_ansi = 446,                            /* -ansi */
  ...
  OPT_cpp_ = 456,                            /* -cpp= */
  OPT_d = 457,                               /* -d */
  OPT_dumpbase = 458,                        /* -dumpbase */
  OPT_dumpdir = 459,                         /* -dumpdir */
  OPT_dumpmachine = 460,                     /* -dumpmachine */
  OPT_dumpspecs = 461,                       /* -dumpspecs */
  OPT_dumpversion = 462,                     /* -dumpversion */
  OPT_e = 463,                               /* -e */
  /* OPT_encoding = 464, */                  /* -encoding */
  OPT_export_dynamic = 465,                  /* -export-dynamic */
  OPT_extdirs = 466,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 467, */               /* -fCLASSPATH= */
  OPT_fPIC = 468,                            /* -fPIC */
  OPT_fPIE = 469,                            /* -fPIE */
  OPT_fRTS_ = 470,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 471,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 472,                   /* -fabi-version= */
  OPT_faccess_control = 473,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 474,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 475,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 476,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 477,                  /* -falign-commons */
  OPT_falign_functions = 478,                /* -falign-functions */
  OPT_falign_functions_ = 479,               /* -falign-functions= */
  OPT_falign_jumps = 480,                    /* -falign-jumps */
  OPT_falign_jumps_ = 481,                   /* -falign-jumps= */
  OPT_falign_labels = 482,                   /* -falign-labels */
  OPT_falign_labels_ = 483,                  /* -falign-labels= */
  OPT_falign_loops = 484,                    /* -falign-loops */
  OPT_falign_loops_ = 485,                   /* -falign-loops= */
  OPT_fall_intrinsics = 486,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 487, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 488,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 489,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 490, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 491, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 492, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 493, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 494, */  /* -fargument-noalias-global */
  OPT_fasan_shadow_offset_ = 495,            /* -fasan-shadow-offset= */
  OPT_fasm = 496,                            /* -fasm */
  OPT_fassert = 497,                         /* -fassert */
  OPT_fassociative_math = 498,               /* -fassociative-math */
  OPT_fassume_compiled = 499,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 500,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 501,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 502,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 503,                   /* -fauto-profile */
  OPT_fauto_profile_ = 504,                  /* -fauto-profile= */
  OPT_fautomatic = 505,                      /* -fautomatic */
  OPT_faux_classpath = 506,                  /* -faux-classpath */
  OPT_fbackslash = 507,                      /* -fbackslash */
  OPT_fbacktrace = 508,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 509,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 510,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 511,              /* -fbootstrap-classes */
  OPT_fbounds_check = 512,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 513,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 514,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 515,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 516,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 517,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 518,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 519,                        /* -fbuiltin */
  OPT_fbuiltin_ = 520,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 521,                    /* -fcall-saved- */
  OPT_fcall_used_ = 522,                     /* -fcall-used- */
  OPT_fcaller_saves = 523,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 524,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 525,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 526,                /* -fcheck-data-deps */
  OPT_fcheck_new = 527,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 528,           /* -fcheck-pointer-bounds */
  OPT_fcheck_references = 529,               /* -fcheck-references */
  OPT_fcheck_ = 530,                         /* -fcheck= */
  OPT_fchkp_check_incomplete_type = 531,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 532,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 533,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 534,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_instrument_calls = 535,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 536,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 537,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 538, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 539,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 540,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 541,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 542, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 543,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 544,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 545,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 546,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 547,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 548,                       /* -fcilkplus */
  OPT_fclasspath_ = 549,                     /* -fclasspath= */
  OPT_fcoarray_ = 550,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 551,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 552,                         /* -fcommon */
  OPT_fcompare_debug = 553,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 554,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 555,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 556,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 557,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 558,                  /* -fcond-mismatch */
  OPT_fconserve_space = 559,                 /* -fconserve-space */
  OPT_fconserve_stack = 560,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 561,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 562,               /* -fconstexpr-depth= */
  OPT_fconvert_ = 563,                       /* -fconvert= */
  OPT_fcprop_registers = 564,                /* -fcprop-registers */
  OPT_fcray_pointer = 565,                   /* -fcray-pointer */
  OPT_fcrossjumping = 566,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 567,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 568, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 569,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 570,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 571,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 572,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 573,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 574,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 575,                       /* -fdbg-cnt= */
  OPT_fdce = 576,                            /* -fdce */
  OPT_fdebug_cpp = 577,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 578,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 579,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 580,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 581,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 582,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 583, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 584,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 585,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 586,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 587,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 588,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 589,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 590,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 591,         /* -fdevirtualize-at-ltrans */
  OPT_fdevirtualize_speculatively = 592,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 593, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 594,             /* -fdiagnostics-color= */
  ...
  OPT_fdisable_assertions = 600,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 601,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 602,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 603,         /* -fdollars-in-identifiers */
  OPT_fdse = 604,                            /* -fdse */
  OPT_fdump_ = 605,                          /* -fdump- */
  OPT_fdump_ada_spec = 606,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 607,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 608, */                /* -fdump-core */
  OPT_fdump_final_insns = 609,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 610,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 611,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 612,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 613,                  /* -fdump-go-spec= */
  ...
  OPT_femit_class_file = 626,                /* -femit-class-file */
  OPT_femit_class_files = 627,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 628,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 629,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 630,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 631,                        /* -fenable- */
  OPT_fenable_assertions = 632,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 633,             /* -fenable-assertions= */
  OPT_fencoding_ = 634,                      /* -fencoding= */
  ...
  OPT_mhard_float = 1197,                    /* -mhard-float */
  OPT_mhle = 1198,                           /* -mhle */
  OPT_mieee_fp = 1199,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1200,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1201,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1202,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1203, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1204,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1205,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1206,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1207,                /* -mlong-double-80 */
  OPT_mlwp = 1208,                           /* -mlwp */
  OPT_mlzcnt = 1209,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1210,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1211,              /* -mmemset-strategy= */
  OPT_mmmx = 1212,                           /* -mmmx */
  OPT_mmovbe = 1213,                         /* -mmovbe */
  OPT_mmpx = 1214,                           /* -mmpx */
  OPT_mms_bitfields = 1215,                  /* -mms-bitfields */
  OPT_mmwaitx = 1216,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1217,            /* -mno-align-stringops */
  OPT_mno_default = 1218,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1219,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1220,                  /* -mno-push-args */
  OPT_mno_red_zone = 1221,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1222,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1223,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1224,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1225,                          /* -mpc32 */
  OPT_mpc64 = 1226,                          /* -mpc64 */
  OPT_mpc80 = 1227,                          /* -mpc80 */
  OPT_mpclmul = 1228,                        /* -mpclmul */
  OPT_mpcommit = 1229,                       /* -mpcommit */
  OPT_mpopcnt = 1230,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1231,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1232,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1233,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1234,                        /* -mprfchw */
  OPT_mpush_args = 1235,                     /* -mpush-args */
  OPT_mrdrnd = 1236,                         /* -mrdrnd */
  OPT_mrdseed = 1237,                        /* -mrdseed */
  OPT_mrecip = 1238,                         /* -mrecip */
  OPT_mrecip_ = 1239,                        /* -mrecip= */
  OPT_mrecord_mcount = 1240,                 /* -mrecord-mcount */
  OPT_mred_zone = 1241,                      /* -mred-zone */
  OPT_mregparm_ = 1242,                      /* -mregparm= */
  OPT_mrtd = 1243,                           /* -mrtd */
  OPT_mrtm = 1244,                           /* -mrtm */
  OPT_msahf = 1245,                          /* -msahf */
  OPT_msha = 1246,                           /* -msha */
  OPT_mskip_rax_setup = 1247,                /* -mskip-rax-setup */
  OPT_msoft_float = 1248,                    /* -msoft-float */
  OPT_msse = 1249,                           /* -msse */
  OPT_msse2 = 1250,                          /* -msse2 */
  OPT_msse2avx = 1251,                       /* -msse2avx */
  OPT_msse3 = 1252,                          /* -msse3 */
  OPT_msse4 = 1253,                          /* -msse4 */
  OPT_msse4_1 = 1254,                        /* -msse4.1 */
  OPT_msse4_2 = 1255,                        /* -msse4.2 */
  OPT_msse4a = 1256,                         /* -msse4a */
  /* OPT_msse5 = 1257, */                    /* -msse5 */
  OPT_msseregparm = 1258,                    /* -msseregparm */
  OPT_mssse3 = 1259,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1260,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1261,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1262,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1263,            /* -mstringop-strategy= */
  OPT_mtbm = 1264,                           /* -mtbm */
  OPT_mtls_dialect_ = 1265,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1266,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1267,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1268,                         /* -mtune= */
  OPT_mveclibabi_ = 1269,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1270,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1271,                    /* -mvzeroupper */
  OPT_mx32 = 1272,                           /* -mx32 */
  OPT_mxop = 1273,                           /* -mxop */
  OPT_mxsave = 1274,                         /* -mxsave */
  OPT_mxsavec = 1275,                        /* -mxsavec */
  OPT_mxsaveopt = 1276,                      /* -mxsaveopt */
  OPT_mxsaves = 1277,                        /* -mxsaves */
  OPT_n = 1278,                              /* -n */
  OPT_no_canonical_prefixes = 1279,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1280,              /* -no-integrated-cpp */
  OPT_no_pie = 1281,                         /* -no-pie */
  OPT_nocpp = 1282,                          /* -nocpp */
  OPT_nodefaultlibs = 1283,                  /* -nodefaultlibs */
  /* OPT_nopie = 1284, */                    /* -nopie */
  ...
  OPT_pthread = 1309,                        /* -pthread */
  OPT_quiet = 1310,                          /* -quiet */
  OPT_r = 1311,                              /* -r */
  OPT_rdynamic = 1312,                       /* -rdynamic */
  OPT_remap = 1313,                          /* -remap */
  OPT_rpath_link = 1314,                     /* -rpath-link */
  OPT_rpath_link_ = 1315,                    /* -rpath-link= */
  OPT_rpath_ = 1316,                         /* -rpath= */
  OPT_s = 1317,                              /* -s */
  ...
  OPT_stdlib_libc__ = 1376,                  /* -stdlib=libc++ */
  OPT_stdlib_libcpp = 1377,                  /* -stdlib=libcpp */
  OPT_stdlib_libcpp_ne = 1378,               /* -stdlib=libcpp-ne */
  OPT_stdlib_libstdc__ = 1379,               /* -stdlib=libstdc++ */
