...
extern __ALWAYS_INLINE __ARTIFICIAL char * stpcpy(char * _Restrict __s1, const char * _Restrict __s2) {
  return __builtin___stpcpy_chk(__s1, __s2, __bos(__s1));
}

extern __ALWAYS_INLINE __ARTIFICIAL char * stpncpy(char * _Restrict __s1, const char * _Restrict __s2, size_t __n) {
  return __builtin___stpncpy_chk(__s1, __s2, __n, __bos(__s1));
}
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/string_chk.h $ $Rev: 806926 $")
#endif
