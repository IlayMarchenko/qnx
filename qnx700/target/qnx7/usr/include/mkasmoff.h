...
#define VALUE( name, val ) unsigned NAME( value, __LINE__, ____##name ) = (unsigned)(val)
#define PVALUE(name, val)  uintptr_t NAME(value, __LINE__, ____##name ) = (uintptr_t)(val)

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/utils/m/mkasmoff/public/mkasmoff.h $ $Rev: 780356 $")
#endif
