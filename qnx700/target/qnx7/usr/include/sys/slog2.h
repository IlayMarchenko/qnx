...
#define SLOG2_FA_STRING( __x )    (size_t)( SLOG2_FA_STRING | ((strlen(__x)+1) & SLOG2_FA_SIZE_MASK ) ), ( __x )
 ...
 */
slog2_buffer_t slog2_find_buffer( const char *buffer_name, const char *buffer_set_name );
...
__SRCVERSION( "$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/slog2/public/sys/slog2.h $ $Rev: 824211 $" )
#endif
