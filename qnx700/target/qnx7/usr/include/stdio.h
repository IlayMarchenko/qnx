...
void _Lockfilelock(_Filet *__filep);
void _Unlockfilelock(_Filet *__filep);
#else /* _MULTI_THREAD */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/stdio.h $ $Rev: 813549 $")
#endif
