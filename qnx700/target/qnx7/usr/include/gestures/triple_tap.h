...
typedef struct {
	...
	triple_tap_params_t params;      /**< The triple tap parameters. */
 ...
 *
 * This function allocates a new triple tap gesture data structure, initializes it with the specified
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/gestures/public/gestures/triple_tap.h $ $Rev: 812267 $")
#endif
