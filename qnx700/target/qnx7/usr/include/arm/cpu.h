 ...
 * IFSR/DFSR bits
 */
#define	ARM_FSR_CM				(1u << 13)
#define	ARM_FSR_ExT				(1u << 12)
#define	ARM_FSR_WnR				(1u << 11)
#define	ARM_FSR_FS4				(1u << 10)
#define	ARM_FSR_FS3_0			(0xfu)
#define	ARM_FSR_FS(x)			(((x) & ARM_FSR_FS3_0) | ((x) & ARM_FSR_FS4))
#define	ARM_FSR_LPAE			(1u << 9)
#define	ARM_FSR_LPAE_CODE		(0x3fu)
#define	ARM_FSR_FS_LPAE(x)		((x) & ARM_FSR_LPAE_CODE)

#define	ARM_FSR_DEBUG			0x2
#define	ARM_FSR_DEBUG_LPAE		0x22
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/services/system/public/arm/cpu.h $ $Rev: 780356 $")
#endif
