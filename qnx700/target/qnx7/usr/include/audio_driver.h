...
/* main.c */
int ado_driver_acquire_capability(uint64_t cap);
int ado_driver_release_capability(uint64_t cap);
int ado_driver_maintain_capability(uint64_t cap);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/services/audio/public/include/audio_driver.h $ $Rev: 819886 $")
#endif
