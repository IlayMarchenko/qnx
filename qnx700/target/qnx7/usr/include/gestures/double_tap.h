 ...
 */
typedef enum {
	DT_STATE_INIT = 0,       /**< The initial state of the double tap gesture. */
	DT_STATE_FIRST_TOUCH,    /**< The state of the double tap gesture after the first touch was detected. */
	DT_STATE_FIRST_RELEASE,  /**< The state of the double tap gesture after the first release was detected. */
	DT_STATE_SECOND_TOUCH,   /**< The state of the double tap gesture after the second touch was detected. */
	DT_STATE_SECOND_RELEASE  /**< The state of the double tap gesture after the second release was detected. */
} double_tap_state_e;
 ...
 *
 * This function allocates a new double tap gesture data structure,
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/gestures/public/gestures/double_tap.h $ $Rev: 812267 $")
#endif
