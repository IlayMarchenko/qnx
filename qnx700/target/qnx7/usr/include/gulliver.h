...
#define ENDIAN_RET16(__x)		(typeof(__x)) __cpu_endian_ret16((_Uint16t)(__x))
#else
#define ENDIAN_RET16(__x)		(typeof(__x))((((__x) >> 8) & 0xff) | \
											(((__x) & 0xff) << 8))
#endif

#ifdef __CPU_ENDIAN_RET32
#define ENDIAN_RET32(__x)		(typeof(__x)) __cpu_endian_ret32((_Uint32t)(__x))
#else
#define ENDIAN_RET32(__x)		(typeof(__x))((((__x) >> 24) & 0xff) | \
											(((__x) >> 8) & 0xff00) | \
											(((__x) & 0xff00) << 8) | \
											(((__x) & 0xff) << 24))
#endif
...
#define ENDIAN_RET64(__x)		(typeof(__x)) __cpu_endian_ret64((_Uint64t)(__x))
#else
#define ENDIAN_RET64(__x)		(typeof(__x))((((__x) >> 56) & 0xffull) | \
											(((__x) >> 40) & 0xff00ull) | \
											(((__x) >> 24) & 0xff0000ull) | \
											(((__x) >>  8) & 0xff000000ull) | \
											(((__x) & 0xff000000ull) <<  8) | \
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/gulliver.h $ $Rev: 822533 $")
#endif
