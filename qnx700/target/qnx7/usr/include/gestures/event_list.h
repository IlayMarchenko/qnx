 ...
 * @brief Event list
 *
 * This structure  is a private data type representing the list of
 ...
 *
 * This structure represents an item in the list of
 * touch events that need to be handled. Use the @c event_list_*() 
 * functions to manipulate the event list.
 */
 ...
 *
 * This function allocates and initializes a new event list.
 ...
 *
 * This function allocates and initializes a new
 ...
 *
 * This function returns an event list to the empty state.
 ...
 *
 * This function  gets the first element in an event list.
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/gestures/public/gestures/event_list.h $ $Rev: 812267 $")
#endif
