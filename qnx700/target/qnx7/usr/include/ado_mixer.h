...
int32_t ado_mixer_destroy ( ado_mixer_t *mixer );

#endif /* _ADO_MIXER_H_INCLUDED_ */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/services/audio/public/include/ado_mixer.h $ $Rev: 818708 $")
#endif
