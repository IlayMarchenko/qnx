 ...
 * @brief Gesture set
 *
 * This structure is a private data type that represents a set
 ...
 *
 * This callback function is invoked when the gesture set
 ...
 *   - the thread that called @c gestures_set_process_event() (@c async == 0)
 *   - the timer thread (@c async == 1)
 *
 ...
 *
 * This function processes incoming touch events by adding them to the
 ...
 *
 * This function processes the event list by adding the events
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/gestures/public/gestures/set.h $ $Rev: 812267 $")
#endif
