...
#define IMG_CODEC_ADD_FUNC(_name,_entry,_func,_limit)	\
	{ if (offsetof(img_codec_funcs_t,_entry) + sizeof(void(*)()) <= (_limit))	\
		(_name)->_entry = _func; }
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/img/lib/public/img/img_codec.h $ $Rev: 780607 $")
#endif
