...
#ifndef _X86_64_CPUINLINE_INCLUDED
#define _X86_64_CPUINLINE_INCLUDED
...
# define __cpu_endian_ret16(__x)                                        \
	(_Uint16t)(__builtin_constant_p(__x)                                \
     ...
     : __extension__ ({                                                 \
            const _Uint16t __reg = (__x);                               \
			((__reg&0xff)<<8) | (__reg>>8); \
         }))
...
# define __cpu_endian_ret32(__x)                                        \
	(_Uint32t)(__builtin_constant_p(__x)                                \
     ...
     : __extension__ ({                                                 \
             _Uint32t __reg = (__x);                                    \
             __asm__ __volatile__ ( "bswap %0" : "+r" (__reg));         \
             __reg;                                                     \
         }))
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/x86_64/cpuinline.h $ $Rev: 801519 $")
#endif
