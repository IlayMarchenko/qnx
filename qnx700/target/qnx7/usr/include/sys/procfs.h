...
typedef debug_thread32_t		procfs_status32;
typedef debug_thread64_t		procfs_status64;
typedef debug_thread_t			procfs_status;
typedef debug_run32_t			procfs_run32;
typedef debug_run64_t			procfs_run64;
typedef debug_run_t				procfs_run;
typedef debug_break32_t			procfs_break32;
typedef debug_break64_t			procfs_break64;
...
typedef debug_irq32_t			procfs_irq32;
typedef debug_irq64_t			procfs_irq64;
typedef debug_irq_t				procfs_irq;
typedef debug_timer32_t			procfs_timer32;
typedef debug_timer64_t			procfs_timer64;
...
/* use __DIO_RAW because we can't encode sizeof(procfs_sysinfo) in the
 * value - breaks things if the size of struct syspage_entry changes */
#define DCMD_PROC_SYSINFO		(__DIO_RAW(_DCMD_PROC, __PROC_SUBCMD_PROCFS + 0, 0x9c, _POSIX_DEVDIR_FROM))
...
#define DCMD_PROC_RUN32			(__DIOT(_DCMD_PROC, __PROC_SUBCMD_PROCFS + 9, procfs_run32))
#define DCMD_PROC_RUN64			(__DIOT(_DCMD_PROC, __PROC_SUBCMD_PROCFS + 9, procfs_run64))
...
#define DCMD_PROC_BREAK32		(__DIOTF(_DCMD_PROC, __PROC_SUBCMD_PROCFS + 14, procfs_break32))
#define DCMD_PROC_BREAK64		(__DIOTF(_DCMD_PROC, __PROC_SUBCMD_PROCFS + 14, procfs_break64))
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/services/system/public/sys/procfs.h $ $Rev: 794315 $")
#endif
