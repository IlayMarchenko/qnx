...
#define URB_FUNCTION_DATA			0x00000040
#define URB_FUNCTION_SETUP			0x00000080
#define URB_CERT_REQUEST			0x00000100
...
#define USBD_STATUS_STATUS_ERRNO		0x20000000
...
#define USBD_STATUS_DEVICE_SUSPENDED	0x00000100
...
#define USBD_HCD_CAP_MULTI_URB			0x4000
#define USBD_HCD_CAP_DMA_64				0x8000
#define USBD_HCD_CAP_NO_PORT_PWR_SWITCH	0x00010000
...
#define USBD_FUNCTION_EVENT_VENDOR_COMMAND					0x01
#define USBD_FUNCTION_EVENT_DEVICE_STATE_CHANGE				0x02
#define USBD_FUNCTION_EVENT_CONFIGURATION_STATE_CHANGE		0x03
#define USBD_FUNCTION_EVENT_INTERFACE_STATE_CHANGE			0x04
#define USBD_FUNCTION_EVENT_ENDPOINT_STATE_CHANGE			0x05
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/usbdi/public/sys/usbdi.h $ $Rev: 801815 $")
#endif
