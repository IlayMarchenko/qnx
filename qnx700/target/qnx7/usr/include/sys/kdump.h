...
#define WRITE_INIT		0	/* Dump is about to begin */
#define WRITE_FINI		1	/* Dump is complete */
#define WRITE_PREINIT	2	/* System boot, for e.g. memory allocation */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/services/kdumper/public/sys/kdump.h $ $Rev: 795009 $")
#endif
