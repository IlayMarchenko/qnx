...
#define SHUTDOWN_SHELFMODE		6       // Used for specific H/W which has power leakage for normal SHUTDOWN_SYSTEM.
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/shutdown/public/sys/shutdown.h $ $Rev: 756950 $")
#endif
