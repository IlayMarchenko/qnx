...
typedef struct usbd_device_qualifier_descriptor {
	_Uint8t					bLength;
	_Uint8t					bDescriptorType;
	_Uint16t				bcdUSB;
	_Uint8t					bDeviceClass;
	...
	_Uint8t					bNumConfigurations;
	_Uint8t					bReserved;
} usbd_device_qualifier_descriptor_t;
...
typedef struct usbd_endpoint_companion_descriptor {
	_Uint8t					bLength;
	_Uint8t					bDescriptorType;
	_Uint8t					bMaxBurst;
	_Uint8t					bmAttributes;
	_Uint16t				wBytesPerInterval;
} usbd_endpoint_companion_descriptor_t;
...
typedef union usbd_descriptors {
	...
	usbd_endpoint_companion_descriptor_t endpoint_companion;
} usbd_descriptors_t;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/usbdci/public/sys/usbdci.h $ $Rev: 820656 $")
#endif
