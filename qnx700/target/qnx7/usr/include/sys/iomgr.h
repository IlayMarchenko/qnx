...
#define _NOTIFY_EDGEEVENT		0x00000001
 ...
 *              met return 0.
 *
 * EDGEARM    - Conditions are considered as met only if a change occurs since
 *              the last call to ionotify(EDGEARM). Met conditions are returned,
 *              a notification is armed for unmet conditions.
 */
...
#define _NOTIFY_ACTION_EDGEARM	0x4
#define _NOTIFY_ACTION_MASK		0x7
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/sys/iomgr.h $ $Rev: 780356 $")
#endif
