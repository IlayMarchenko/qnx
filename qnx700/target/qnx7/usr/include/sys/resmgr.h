...
#define _RESMGR_DELAY_CLOSE		(int)((~0U ^ (~0U >> 1U)) | 2U) /* For _IO_CLOSE only. Similar to _RESMGR_NO_REPLY
                                                                   but means the user will reply later.
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/sys/resmgr.h $ $Rev: 817476 $")
#endif
