...
#define ELFCORE_AUTO_TYPE           0x00000020u /**< dump memory based on size */
#define ELFCORE_DUMP_LNKMAP_ALT     0x00000040u /**< force use alternate method to create link map note. */
 ...
 */
int elfcore(int fd, elfcore_file_t *fp, uint64_t coresize, unsigned flags);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/elfcore/public/sys/elfcore.h $ $Rev: 806072 $")
#endif
