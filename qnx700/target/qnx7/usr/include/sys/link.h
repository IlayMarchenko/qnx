...
typedef int (*Dl_Iterate_Phdr_t) (const struct dl_phdr_info *info, size_t size, void *data);
...
int dl_iterate_phdr(Dl_Iterate_Phdr_t callback, void *data);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/sys/link.h $ $Rev: 806926 $")
#endif
