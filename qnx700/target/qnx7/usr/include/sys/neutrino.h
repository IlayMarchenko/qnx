...
#define _NTO_VERSION	700	/* version number * 100 */
...
#define _NTO_KEYDATA_PATHSIGN_CALCULATE		(_NTO_KEYDATA_CALCULATE|_NTO_KEYDATA_PATHSIGN)
#define _NTO_KEYDATA_PATHSIGN_CALCULATE_REUSE	(_NTO_KEYDATA_CALCULATE_REUSE|_NTO_KEYDATA_PATHSIGN)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/services/system/public/sys/neutrino.h $ $Rev: 817442 $")
#endif
