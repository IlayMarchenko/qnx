...
struct nw_work_thread {
	int			wt_critical;
	int			wt_intr_pending; /* Unused */
	enum intr_sigstate        intr_sighot;
	unsigned                  am_stack;
	unsigned                  blocking;
	unsigned                  inreceive;
...
extern void pcreat_setbigstack(struct proc *p);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/io-pkt/sys/nw_datastruct.h $ $Rev: 800987 $")
#endif
