...
/* structure for resources storage/handling */
typedef struct
{
	const char *name;         /* name of resource */
	const char *description;  /* description of resource */
	void       *value;        /* filled in later with the value */
	const void *info;         /* typing info (ie range, list of items, etc) */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/aoi/public/aoi/aoi_resources.h $ $REV$")
#endif
