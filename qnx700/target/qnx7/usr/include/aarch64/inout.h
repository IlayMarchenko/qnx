...
#ifndef _AARCH64_INOUT_H_INCLUDED
#define _AARCH64_INOUT_H_INCLUDED

/*
 *  Define the in/out functions for AArch64
 *
 * FIXME: do we need to add dsb() to all the out*() functions?
 */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/c/public/aarch64/inout.h $ $Rev: 818787 $")
#endif
