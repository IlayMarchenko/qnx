...
typedef struct {
	...
	tft_params_t params;                 /**< The two-finger tap parameters. */
 ...
 *
 * This function allocates a new two-finger tap gesture data structure,
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/gestures/public/gestures/two_finger_tap.h $ $Rev: 812267 $")
#endif
