...
#ifndef _FS_ABILITY_H_
#define _FS_ABILITY_H_
...
#define BLK_ABILITY_FSCTL       "vfs/fs-control"
#define BLK_ABILITY_HOOKCTL     "vfs/hook-control"

#endif /* FS_ABILITY_H_ */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/services/blk/io-blk/public/sys/fs_ability.h $ $Rev: 756950 $")
#endif /* FS_ABILITY_H_ */
