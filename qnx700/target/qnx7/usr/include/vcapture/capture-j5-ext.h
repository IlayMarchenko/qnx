...
#define CAPTURE_PROPERTY_J6_SDMA_CHANNEL	CAPTURE_PROPERTY( '6', 'S', 'C', 'N' )
	/* R/W		int			Sets the sdma channel, for de-interlacing use. J6 only (0~31, board specific; or -1 for default)
	 *						-1: the capture library try to accquire a SDMA channel from resource database. If SDMA channel
	 *						is not registered in the resource database, capture_update() will fail. */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/hardware/wfd/jacinto5/caplib/public/vcapture/capture-j5-ext.h $ $Rev: 792007 $")
#endif
