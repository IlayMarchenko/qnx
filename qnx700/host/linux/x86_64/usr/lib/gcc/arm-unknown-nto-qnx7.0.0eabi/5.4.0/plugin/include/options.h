...
enum opt_code
{
  ...
  OPT_Wmain = 290,                           /* -Wmain */
  OPT_Wmasked_catch_block = 291,             /* -Wmasked-catch-block */
  OPT_Wmaybe_uninitialized = 292,            /* -Wmaybe-uninitialized */
  ...
  OPT_mapcs = 1142,                          /* -mapcs */
  OPT_mapcs_float = 1143,                    /* -mapcs-float */
  OPT_mapcs_frame = 1144,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1145,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1146,              /* -mapcs-stack-check */
  OPT_march_ = 1147,                         /* -march= */
  OPT_marm = 1148,                           /* -marm */
  OPT_masm_syntax_unified = 1149,            /* -masm-syntax-unified */
  OPT_mbig_endian = 1150,                    /* -mbig-endian */
  ...
  OPT_rpath_link = 1221,                     /* -rpath-link */
  OPT_rpath_link_ = 1222,                    /* -rpath-link= */
  OPT_rpath_ = 1223,                         /* -rpath= */
  OPT_s = 1224,                              /* -s */
  ...
  OPT_stdlib_libc__ = 1283,                  /* -stdlib=libc++ */
  OPT_stdlib_libcpp = 1284,                  /* -stdlib=libcpp */
  OPT_stdlib_libcpp_ne = 1285,               /* -stdlib=libcpp-ne */
  OPT_stdlib_libstdc__ = 1286,               /* -stdlib=libstdc++ */
