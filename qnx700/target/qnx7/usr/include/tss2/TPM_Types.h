...
// QNX Commented the following line given it is unused, and it's defining a "pinLimit" type which
// QNX makes no sense given the original intent derived from the accompanying comment
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/7.0.0/trunk/lib/tss/ibmtss/public/tss2/TPM_Types.h $ $Rev: 820309 $")
#endif
